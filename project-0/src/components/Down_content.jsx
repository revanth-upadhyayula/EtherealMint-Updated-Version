    ...
    return (
        <main>
            <section className="down" >
                <div className="he">
                    <motion.h2 initial={{opacity:0,x:-200}} whileInView={{opacity:1,x:0}} transition={{duration: 1,delay:1,ease:"easeOut"}} viewport={{once:true,amount:1}} className="h21">What is</motion.h2>
                ...
                <div className="downmain">
                    <div className="para">
                        <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 1,delay:1,ease:"easeOut"}} viewport={{once:true}} className="text-lg text-gray-700 mb-4">
                        ...
                        <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 1,delay:1.5,ease:"easeOut"}} viewport={{once:true}} className="text-lg text-gray-700">
